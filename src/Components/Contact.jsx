...
import { Grid, Typography, Paper, Box, useMediaQuery, useTheme } from '@mui/material';
...
const Contact = () => {
  ...
  return (
    <Grid container spacing={3} marginTop={5}>
      ...
      {/* Right side - Content */}
      <Grid item xs={12} md={6} style={{ padding: isMobile ? '20px 10px' : '20px' }} marginTop={5}>
        <Typography variant="body1" className="david-libre-bold" dir="rtl" style={{ fontSize: isMobile ? 18 : 25 }}>
          <b>
        ...
        <Box display="flex" justifyContent={isMobile ? 'center' : 'center'} alignItems="center" mt={5}>
          <Box mx={2} style={{ marginLeft: '30%', marginTop: '15%'}}>
            <a href="https://embed.waze.com/iframe?zoom=16&lat=32.518071&lon=34.918732&ct=livemap" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faWaze} size={isMobile ? '3x' : '4x'} style={{ color: '#FFF' }} />
            </a>
          </Box>
        </Box>
      </Grid>
